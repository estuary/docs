...
![](<../../.gitbook/assets/Flow Architecture(3).png>)
...
Reductions occur automatically during the materialization process based on the [collection key](collections.md#collection-keys) and the type of endpoint. This is driven by the [connector](../../connectors.md) in use.
